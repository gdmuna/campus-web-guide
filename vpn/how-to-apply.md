...
> [!IMPORTANT] 重要消息：
>
> 1. 目前所有同学已自动创建了校园网的初始账号，如需使用校园 VPN ，请直接使用校园网账号登录即可。
> 2. 如果您之前没使用过校园网，则登录账号为学号，密码为888888；如果您使用过校园网，则登录账号为学号，密码与校园网的密码相同；如果您申请修改校园网的密码，则24小时后校园 VPN 的密码也会同步修改。
> 3. 若使用校园网账号仍然无法登录 VPN ，此时再通过 `广东医网办大厅` 申请 VPN 账号。
